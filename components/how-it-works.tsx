...
const steps = [
  {
    ...
    description: "Configure smart reminders for tasks, deadlines, and follow-ups that matter to your team.",
  },
  {
    icon: Zap,
    title: "Intelligent Delivery",
    description: "Our AI learns when and how to nudge each team member for maximum effectiveness.",
  },
  {
    icon: CheckCircle,
    title: "Stay Aligned",
    description: "Everyone stays on track, deadlines are met, and nothing falls through the cracks.",
  },
]
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
            Three simple steps to keep your entire team aligned and productive
          </p>
        </div>
