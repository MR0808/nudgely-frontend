...
const benefits = [
  {
    ...
    description: "Smart reminders ensure critical tasks and deadlines are always top of mind for your team.",
  },
  {
    icon: Users,
    title: "Improve Team Coordination",
    description: "Keep everyone in sync with automated follow-ups and status updates that actually get read.",
  },
  {
    icon: TrendingUp,
    ...
    <section id="benefits" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight">Why Teams Love Nudgely</h2>
